...
def pipeline(task: str, model: str, **kwargs) -> "DetectorPipeline":
    ...
    model_map = {
        ...
        "seqxgpt-tuned": "omini_text.detectors.seqxgpt_detector.SeqXGPTDetector",
        ...
        "openai-detector": "omini_text.detectors.openai_detector.OpenAIDetector",
        ...
        "gl-clic": "omini_text.detectors.gl_clic_detector.GLCLiCDetector",
        "sendetex": "omini_text.detectors.sendetex_detector.SenDetEXDetector",
        "adaloc": "omini_text.detectors.adaloc_detector.AdaLocDetector",
    }
