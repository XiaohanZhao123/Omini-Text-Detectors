...
def load_model(model_name, device, cache_dir):
    ...
    if device == 'auto':
        ...
        device_map = 'auto'
        print('Using automatic multi-GPU placement')
    elif device == 'cpu':
        # CPU only
        device_map = {'': 'cpu'}
    elif ',' in device:
        ...
        max_memory = {gpu_id: f"{torch.cuda.get_device_properties(gpu_id).total_memory // 1024**3 - 1}GiB"
    ...
    # Add device_map if using multi-GPU
    if device_map:
