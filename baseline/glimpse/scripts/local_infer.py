...
from baseline.glimpse.scripts.probability_distribution_estimation import (
    OpenAIGPT,
    PdeFastDetectGPT,
)
from baseline.glimpse.scripts.probability_distributions import GeometricDistribution
...
class Glimpse:
    def __init__(self, args):
        ...
        self.criterion_fn = PdeFastDetectGPT(
            GeometricDistribution(args.top_k, args.rank_size)
        )
        ...
        distrib_params = {
            "babbage-002_geometric": {
                "mu0": -5.1874,
                "sigma0": 2.0760,
                "mu1": -1.3959,
                "sigma1": 4.1521,
            },
            "davinci-002_geometric": {
                "mu0": -3.8289,
                "sigma0": 2.0131,
                "mu1": -0.0733,
                "sigma1": 4.0261,
            },
            "gpt-35-turbo-1106_geometric": {
                "mu0": -5.2040,
                "sigma0": 2.0716,
                "mu1": -0.7821,
                "sigma1": 4.1432,
    ...
    def compute_crit(self, text):
        ...
        crit = self.criterion_fn(self.args, result)
...
def run(args):
    ...
    while True:
        ...
        print(
            f"Glimpse criterion is {crit:.4f}, suggesting that the text has a probability of {prob * 100:.0f}% to be machine-generated."
        )
        print()
